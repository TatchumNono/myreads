...
function App() {
  ...
  useEffect(() => {
    //runs on the first render and gets an array that contains all the 
    //books for the different shelves.
    //runs again if the the update array changes and 
    //it automatically refreshes the page when a book is updated
    api
      .getAll()
      .then((res) => {
        let info = res;
